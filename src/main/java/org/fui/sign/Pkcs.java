...
public class Pkcs {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String issuerStr = "CN=电子签章,OU=gitee示例,O=xfreng,C=CN,E=xiong_jx@foxmail,L=长沙,ST=长沙";
        String subjectStr = "CN=jcoffee,OU=feng5199,O=xfreng,C=CN,E=xiong_jx@foxmail.com,L=长沙,ST=长沙";
